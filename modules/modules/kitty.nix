{ pkgs, config, ... }: {
  programs.kitty = {
    ...
    settings = {
      ...
      color0 = config.palette.bg; # "#3c3836"
      ...
      color8 = config.palette.br_bg;
      color9 = config.palette.br_red; # "#928374"
      color10 = config.palette.br_green; # "#fb4934"
      color11 = config.palette.br_yellow; # "#b8bb26"
      color12 = config.palette.br_blue; # "#fabd2f"
      color13 = config.palette.br_purple; # "#83a598"
      color14 = config.palette.br_aqua; # "#d3869b"
      color15 = config.palette.white; # "#8ec07c"
